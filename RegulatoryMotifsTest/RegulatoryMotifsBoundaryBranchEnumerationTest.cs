...
namespace RegulatoryMotifsTest
{
    ...
    public class RegulatoryMotifsBoundaryBranchEnumerationTest
    {
        ...
        public void ExecuteTestCasepAllResultDecisionMaxAsCriteriaAcceptible0()
        {
            ...
            RegulatoryMotifsBoundaryBranchEnumeration enumeration = new RegulatoryMotifsBoundaryBranchEnumeration(alphabet, charSets, substringLength)
            {
        ...
        public void ExecuteTestCasepNotAllResultOptimizationMaxAsCriteriaExpexted0()
        {
            ...
            char[] alphabet = new char[] { 'a', 'c', 'g', 't' };
            int substringLength = 5;
            RegulatoryMotifsBoundaryBranchEnumeration enumeration = new RegulatoryMotifsBoundaryBranchEnumeration( alphabet, charSets, substringLength, pIsAllResult: false, pIsOptimizitaion: true, pIsSumAsCriteria: false)
            {
                StatisticAccumulator = new FakeRegulatoryMotifsStatisticAccumulator()
            };
            // act
        ...
        public void ExecuteTestCasepNotAllResultOptimizationSumAsCriteriaExpexted351()
        {
            ...
            char[] alphabet = new char[] { 'a', 'c', 'g', 't' };
            int substringLength = 5;
            RegulatoryMotifsBoundaryBranchEnumeration enumeration = new RegulatoryMotifsBoundaryBranchEnumeration( alphabet, charSets, substringLength, pIsAllResult: true, pIsOptimizitaion: true, pIsSumAsCriteria: true)
            {
                StatisticAccumulator = new FakeRegulatoryMotifsStatisticAccumulator()
            };
            // act
        ...
        public void ExecuteTestCasepAllResultDecisionMaxAsCriteriaAccept0()
        {
            ...
            char[] alphabet = new char[] { 'a', 'c', 'g', 't' };
            int substringLength = 5;
            RegulatoryMotifsBoundaryBranchEnumeration enumeration = new RegulatoryMotifsBoundaryBranchEnumeration( alphabet, charSets, substringLength, pIsAllResult: true, pIsOptimizitaion: false, pIsSumAsCriteria: false, pAcceptibleDistance: 0)
            {
                StatisticAccumulator = new FakeRegulatoryMotifsStatisticAccumulator()
            };
            // act
        ...
        public void ExecuteTestCasepAllResultDecisionMaxAsCriteriaAccept2()
        {
            ...
            char[] alphabet = new char[] { 'a', 'c', 'g', 't' };
            int substringLength = 5;
            RegulatoryMotifsBoundaryBranchEnumeration enumeration = new RegulatoryMotifsBoundaryBranchEnumeration(alphabet, charSets, substringLength, pIsAllResult: true, pIsOptimizitaion: false, pIsSumAsCriteria: false, pAcceptibleDistance: 2)
            {
                StatisticAccumulator = new FakeRegulatoryMotifsStatisticAccumulator()
            };
        ...
        public void ExecuteTestCasepAllResultDecisionSumAsCriteriaAccept2()
        {
            ...
            char[] alphabet = new char[] { 'a', 'c', 'g', 't' };
            int substringLength = 5;
            RegulatoryMotifsBoundaryBranchEnumeration enumeration = new RegulatoryMotifsBoundaryBranchEnumeration(alphabet, charSets, substringLength, pIsAllResult: true, pIsOptimizitaion: false, pIsSumAsCriteria: true, pAcceptibleDistance: 2)
            {
                StatisticAccumulator = new FakeRegulatoryMotifsStatisticAccumulator()
            };
            // act
